...
import { createRecommendationRequest } from "../graphql/mutations";
export default function RecommendationRequestCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFit_preference(initialValues.fit_preference);
    setProduct_url(initialValues.product_url);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createRecommendationRequest.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "RecommendationRequestCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
