...
export default function MeasurementsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBust(initialValues.bust);
    setWaist(initialValues.waist);
    setHips(initialValues.hips);
    setShoulder_width(initialValues.shoulder_width);
    setLeft_thigh(initialValues.left_thigh);
    setLeft_arm(initialValues.left_arm);
    setRight_arm(initialValues.right_arm);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createMeasurements.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MeasurementsCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
