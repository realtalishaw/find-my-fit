...
import { createSilhouettePropeties } from "../graphql/mutations";
export default function SilhouettePropetiesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSilhouette(initialValues.silhouette);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createSilhouettePropeties.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SilhouettePropetiesCreateForm")}
      {...rest}
    >
      <TextField
        label="Silhouette"
